...
public class EntityManagementNestedStatusSubmittedTest extends TestcontainersLifecycle {
    ...
    public void testUpdateStatus() {
        ...
        dataProduct.setStatus(StatusType.SUBMITTED);
        ...
        assertEquals(StatusType.SUBMITTED, retrievedDataProduct1.getStatus());
