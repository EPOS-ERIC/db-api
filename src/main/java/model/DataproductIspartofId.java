...
@Embeddable
public class DataproductIspartofId implements java.io.Serializable {
    private static final long serialVersionUID = -7335414021699140565L;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || org.springframework.data.util.ProxyUtils.getUserClass(this) != org.springframework.data.util.ProxyUtils.getUserClass(o))
            return false;
        DataproductIspartofId entity = (DataproductIspartofId) o;
