...
@Entity
@Table(name = "softwareapplication_provider", schema = "metadata_catalogue")
public class SoftwareapplicationProvider {
    @EmbeddedId
    private SoftwareapplicationProviderId id;
    ...
    public SoftwareapplicationProvider() {
        this.id = new SoftwareapplicationProviderId();
    }

    public SoftwareapplicationProviderId getId() {
        return id;
    }

    public void setId(SoftwareapplicationProviderId id) {
        this.id = id;
    }
    ...
    public void setSoftwareapplicationInstanceId(String softwareapplicationInstanceId) {
        if (id == null) id = new SoftwareapplicationProviderId();
