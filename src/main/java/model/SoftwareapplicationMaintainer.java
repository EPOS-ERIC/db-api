...
@Entity
@Table(name = "softwareapplication_maintainer", schema = "metadata_catalogue")
public class SoftwareapplicationMaintainer {
    @EmbeddedId
    private SoftwareapplicationMaintainerId id;
    ...
    public SoftwareapplicationMaintainer() {
        this.id = new SoftwareapplicationMaintainerId();
    }

    public SoftwareapplicationMaintainerId getId() {
        return id;
    }

    public void setId(SoftwareapplicationMaintainerId id) {
        this.id = id;
    }
    ...
    public void setSoftwareapplicationInstanceId(String softwareapplicationInstanceId) {
        if (id == null) id = new SoftwareapplicationMaintainerId();
