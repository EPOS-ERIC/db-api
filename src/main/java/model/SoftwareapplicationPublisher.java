...
@Entity
@Table(name = "softwareapplication_publisher", schema = "metadata_catalogue")
public class SoftwareapplicationPublisher {
    @EmbeddedId
    private SoftwareapplicationPublisherId id;
    ...
    public SoftwareapplicationPublisher() {
        this.id = new SoftwareapplicationPublisherId();
    }

    public SoftwareapplicationPublisherId getId() {
        return id;
    }

    public void setId(SoftwareapplicationPublisherId id) {
        this.id = id;
    }
    ...
    public void setSoftwareapplicationInstanceId(String softwareapplicationInstanceId) {
        if (id == null) id = new SoftwareapplicationPublisherId();
