...
public abstract class VersioningAndApproval {
     ...
     */
     @Schema(name="versionId", description = "VersionId is the id of the instance", example = "7346238746372", required = false)
     private String versionId;

    /**
     * instanceId is the id of the instance
     */
    @Schema(name="instanceId", description = "InstanceId is the id of the instance", example = "3482364872364782", required = false)
    private String instanceId;

    /**
     * metaId is the id of the entity, is the same across all the different instances
     */
    @Schema(name="metaId", description = "MetaId is the id of the entity, is the same across all the different instances", example = "8423876238756278", required = false)
    private String metaId;

    /**
     * instanceId of the previous version of the instance
     */
    @Schema(name="instanceChangedId", description = "AUTOGENERATED - InstanceId of the previous version of the instance", example = "232465346363", required = false)
    private String instanceChangedId;

    /**
     * timestamp when the last change happened
     */
    @Schema(name="changeTimestamp", description = "AUTOGENERATED - Timestamp when the last change happened", example = "2024-07-03T00:00:00", required = false)
    private LocalDateTime changeTimestamp;

    /**
     * last operation type
     */
    @Schema(name="operation", description = "Last operation type", example = "commit", required = false)
    private String operation;

    /**
     * metaId of the editor
     */
    @Schema(name="editorId", description = "AUTOGENERATED - MetaId of the editor", example = "342374275648", required = false)
    private String editorId;

    /**
     * comment of the user when he create the draft
     */
    @Schema(name="changeComment", description = "Comment of the user when on commit", example = "Example of comment", required = false)
    private String changeComment;

    /**
     * version tag
     */
    @Schema(name="version", description = "version tag", example = "1.0", required = false)
     ...
     */
    @Schema(name="toBeDelete", description = "Mark an entity to be deleted when the fake instance in the approval process is published.", example = "true", required = false)
    private String toBeDelete;

    /**
     * If ingested it contains from which file it was ingested.
     */
    @Schema(name="fileProvenance", description = "AUTOGENERATED - If ingested it contains from which file it was ingested.", example = "file://file.ttl", required = false)
